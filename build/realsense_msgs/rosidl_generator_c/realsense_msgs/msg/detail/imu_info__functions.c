...
bool
realsense_msgs__msg__IMUInfo__are_equal(const realsense_msgs__msg__IMUInfo * lhs, const realsense_msgs__msg__IMUInfo * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
realsense_msgs__msg__IMUInfo__copy(
  const realsense_msgs__msg__IMUInfo * input,
  realsense_msgs__msg__IMUInfo * output)
{
  if (!input || !output) {
    return false;
  }
...
realsense_msgs__msg__IMUInfo__create()
{
  ...
  realsense_msgs__msg__IMUInfo * msg = (realsense_msgs__msg__IMUInfo *)allocator.allocate(sizeof(realsense_msgs__msg__IMUInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
...
realsense_msgs__msg__IMUInfo__Sequence__init(realsense_msgs__msg__IMUInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (realsense_msgs__msg__IMUInfo *)allocator.zero_allocate(size, sizeof(realsense_msgs__msg__IMUInfo), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  realsense_msgs__msg__IMUInfo__Sequence * array = (realsense_msgs__msg__IMUInfo__Sequence *)allocator.allocate(sizeof(realsense_msgs__msg__IMUInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
realsense_msgs__msg__IMUInfo__Sequence__are_equal(const realsense_msgs__msg__IMUInfo__Sequence * lhs, const realsense_msgs__msg__IMUInfo__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!realsense_msgs__msg__IMUInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
realsense_msgs__msg__IMUInfo__Sequence__copy(
  const realsense_msgs__msg__IMUInfo__Sequence * input,
  realsense_msgs__msg__IMUInfo__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(realsense_msgs__msg__IMUInfo);
    realsense_msgs__msg__IMUInfo * data =
      (realsense_msgs__msg__IMUInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense_msgs__msg__IMUInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense_msgs__msg__IMUInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!realsense_msgs__msg__IMUInfo__copy(
