...
#include "autocar_msgs/msg/detail/path2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Path2D__ros_msg_type = autocar_msgs__msg__Path2D;
...
static uint32_t _Path2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autocar_msgs__msg__Path2D(
...
{
  return max_serialized_size_autocar_msgs__msg__Path2D(
    full_bounded, 0);
}
