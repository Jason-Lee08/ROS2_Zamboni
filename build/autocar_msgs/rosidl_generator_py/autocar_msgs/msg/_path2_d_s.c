...
bool autocar_msgs__msg__path2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autocar_msgs.msg._path2_d.Path2D", full_classname_dest, 32) == 0);
  }
  autocar_msgs__msg__Path2D * ros_message = _ros_message;
  {  // poses
...
PyObject * autocar_msgs__msg__path2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autocar_msgs.msg._path2_d");
