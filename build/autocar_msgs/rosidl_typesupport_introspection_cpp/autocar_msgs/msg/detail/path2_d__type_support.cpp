...
{
  new (message_memory) autocar_msgs::msg::Path2D(_init);
}

void Path2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autocar_msgs::msg::Path2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path2D_message_member_array[1] = {
  {
    "poses",  // name
    ...
    offsetof(autocar_msgs::msg::Path2D, poses),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Path2D_message_members = {
  ...
  "Path2D",  // message name
  1,  // number of fields
  sizeof(autocar_msgs::msg::Path2D),
...
{
  return &::autocar_msgs::msg::rosidl_typesupport_introspection_cpp::Path2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autocar_msgs, msg, Path2D)() {
  return &::autocar_msgs::msg::rosidl_typesupport_introspection_cpp::Path2D_message_type_support_handle;
}
